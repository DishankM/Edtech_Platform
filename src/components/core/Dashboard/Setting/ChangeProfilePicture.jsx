...
function ChangeProfilePicture() {
  ...
  return (
    <div className='flex items-center justify-between rounded-md text-richblack-5 bg-richblack-800 py-4 px-8'>
        ...
        <img src={previewSource || user?.image}
            ...
            <div className="space-y-2">
              ...
              <div className='flex items-center gap-x-4'>
                ...
                onChange={handleFileChange}  accept='image/png, image/gif, image/jpeg'
                className='hidden'/>
