...
import LearnigGrid from '../components/core/AboutPage/LearnigGrid'
  ...
  return (
    ...
    <section className='bg-richblack-700'>
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
            <header className='text-4xl py-20 mx-auto font-semibold lg:w-[70%]'>
                Driving Innovation in online Education for a 
                <HighlightText text={"Brighter Future"}/>
                <p className='mx-automt mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>
            ...
            <div className='flex flex-col mx-auto w-11/12 max-w-maxContent justify-between gap-10 text-richblack-500'>
                <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                    ...
                    <div>
                        ...
                        className='shadow-[0_0_20px_0] shadow-[#FC7757]'/>
                    </div>
                </div>
