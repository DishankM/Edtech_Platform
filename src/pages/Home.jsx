  ...
  return (
    <div> 
       ...
       <div className=' mx-auto relative flex flex-col w-11/12 items-center justify-between text-white '>
        ...
        <div className='m-4 w-[90%] text-center text-lg font-bold text-richblack-300'>
        ...
        <div className='mx-3 my-12 shadow-blue-200 w-[85%] relative'>
        <div className='grad-2 -top-10 w-[800px]'></div>
       ...
       {/* Code Section 1*/}
        ...
        <div>
          <CodeBlocks 
            ...
            subheading={
              "Go ahead, give it a try. Our hands-on-learning enviroment means you'll be writing real code from your very first lesson."
            }
            ctabtn1={
              {
       ...
       <div className='w-11/12 mx-auto max-w-maxContent flex flex-row items-center justify-between gap-8 first-letter
        bg-richblack-900 text-white'>
            <InstructorSection/>
       </div>
       <h2 className='text-center text-4xl font-semibold mt-10 bg-white'>reveiw from other Learners</h2>
            {/* Review Slider */}
   </div>
  )
}
