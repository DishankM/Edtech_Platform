                ...
                (
                    <div className='max-w-[500px] p-4 lg:p-8 '>
                        ...
                        <p className='my-4 text-[1.125rem] leading-[1.625rem]
                         text-richblack-100'>Almost done. Enter your new password and youre all set.</p>
                        <form onSubmit={handleOnSubmit}>
                            <div className='relative mt-4'>
                            <label>
                            <p class="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">
                                New Password <sup class="text-pink-200">*</sup></p>
                                <input required
                                 ...
                                 className="absolute right-3 top-9 z-[10] cursor-pointer">
                                    {
                                        showPassword ? (<AiFillEyeInvisible fontSize={24} fill="#AFB2BF" color="white"/>): (<AiFillEye fontSize={24} fill="#AFB2BF" color="white"/>)
                                    }
                                 </span>
                             </label>
                            </div>
                            ...
                            <p class="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">Confirm New Password <sup class="text-pink-200">*</sup></p>
                                ...
                                className='absolute right-3 top-9 z-[10] cursor-pointer '>
                                    {
                                        showConfirmPassword ? (<AiFillEyeInvisible fontSize={24} fill="#AFB2BF" color="white"/>): (<AiFillEye fontSize={24} fill="#AFB2BF" color="white"/>)
                                    }
                                 </span>
                            </label>
                           </div>
